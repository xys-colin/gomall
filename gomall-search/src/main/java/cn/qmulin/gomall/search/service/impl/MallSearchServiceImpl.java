...
import cn.qmulin.gomall.search.feign.ProductFeignService;
import cn.qmulin.gomall.search.service.MallSearchService;
import cn.qmulin.gomall.search.vo.AttrResponseVo;
import cn.qmulin.gomall.search.vo.BrandVo;
    ...
    private SearchResult buildSearchResult(SearchResponse response,SearchParam param) {
        ...
        if (param.getAttrs() !=null && param.getAttrs().size()>0){
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                if (r.getCode() == 0){
                    AttrResponseVo attrResponseVo = (AttrResponseVo) r.get("attr");
