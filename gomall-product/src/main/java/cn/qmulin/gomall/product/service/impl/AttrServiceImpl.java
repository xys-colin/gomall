...
import cn.qmulin.gomall.product.dao.AttrAttrgroupRelationDao;
import cn.qmulin.gomall.product.dao.AttrGroupDao;
...
import cn.qmulin.gomall.product.dao.AttrDao;
...
//        attrEntity.setAttrName(attr.getAttrName());
    ...
    public PageUtils queryBaseAttrPage(Map<String, Object> params, Long catelogId, String type) {
        ...
        List<AttrRespVo> respVos = records.stream().map((attrEntity) -> {
            ...
            val categoryEntity = categoryDao.selectById(attrEntity.getCatelogId());
