...
import cn.qmulin.common.constant.ProductConstant;
import cn.qmulin.common.vo.SkuHasStockVo;
import cn.qmulin.common.to.es.SkuEsModel;
import cn.qmulin.common.utils.R;
import cn.qmulin.gomall.product.entity.*;
import cn.qmulin.gomall.product.feign.CouponFeignService;
import cn.qmulin.common.to.SkuReductionTo;
import cn.qmulin.common.to.SpuBoundTo;
import cn.qmulin.gomall.product.feign.SearchFeignService;
import cn.qmulin.gomall.product.feign.WareFeignService;
import cn.qmulin.gomall.product.vo.*;
...
import cn.qmulin.gomall.product.dao.SpuInfoDao;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        try {
            ...
            hasStockMap = data.stream().collect(Collectors.toMap(SkuHasStockVo::getSkuId, SkuHasStockVo::isHasStock));
        } catch (Exception e) {
        ...
        // TODO 5 将数据发送到es进行保存：gomall-search
